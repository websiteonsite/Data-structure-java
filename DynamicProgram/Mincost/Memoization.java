package DynamicProgram.Mincost;
...
public class Memoization {
    ...
    public static int minCostR(int[][] cost, int i, int j, int[][] dp) {
        ...
        // create the dp to add one extra row and column to the matrix
        // min cost taken to reach from (i,j) to (m-1, n-1)
        // min cost 2D dp Array
